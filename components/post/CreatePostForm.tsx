    ...
    <form action={clientAction} className="space-y-8">
      ...
      <div className="flex items-center justify-end gap-4 pt-6 border-t border-white/10 mt-10">
        ...
        <div className="relative group">
          <div className="absolute -inset-1 bg-gradient-to-r from-primary to-purple-600 rounded-xl blur opacity-30 group-hover:opacity-60 transition duration-500 pointer-events-none" />
          <SubmitButton />
        </div>
      </div>
    </form>
